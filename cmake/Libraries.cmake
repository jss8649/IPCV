...
function(imgs_set_library_prefix PREFIX)
...
function(imgs_add_library LIB_NAME)
  set(options)
  set(oneValueArgs)
  set(multiValueArgs SOURCES HEADERS)
  cmake_parse_arguments(imgs_add_library "${options}" "${oneValueArgs}"
                                         "${multiValueArgs}" ${ARGN})

  if (NOT DEFINED LIB_NAME)
    message(FATAL_ERROR "imgs_add_library(): LIB_NAME not defined")
  endif()
  ...
  add_library(${LIB_NAME} ${imgs_add_library_SOURCES} 
                          ${imgs_add_library_HEADERS})
...
#   HEADERS  Named parameter for the headers that go into the library
function(imgs_add_interface_library LIB_NAME)
  set(options)
  set(oneValueArgs)
  set(multiValueArgs HEADERS)
  cmake_parse_arguments(imgs_add_interface_library "${options}" 
                                                   "${oneValueArgs}"
                                                   "${multiValueArgs}" 
                                                   ${ARGN})

  if (NOT DEFINED LIB_NAME)
    message(FATAL_ERROR "imgs_add_interface_library(): LIB_NAME not defined")
  endif()
