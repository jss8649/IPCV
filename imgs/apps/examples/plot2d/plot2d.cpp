...
int main(int argc, char* argv[]) {
  ...
  status = plot::Plot2d(xs, ys, params);
  ...
  status = plot::Plot2d(xm, ym, params);
  ...
  status = plot::Plot2d(xms, yms, params);
  ...
  status = plot::Plot2d(xmi, ymi, params);
