/** Interface file for CFA demosaic function using homogeneity directed interpolation
 *
 *  \file ipcv/demosaic/Homogeneity.h
 ...
 */
cv::Mat Homogeneity(const cv::Mat& src, string pattern = "GBRG");
}
